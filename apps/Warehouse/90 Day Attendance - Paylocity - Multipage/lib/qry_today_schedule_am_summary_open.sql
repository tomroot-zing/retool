select sch.location_name, p.position_name,
  CASE WHEN u.employee_code is null then '' else u.employee_code end as open_shift,
...
and sch.location_name NOT LIKE 'PM%'
